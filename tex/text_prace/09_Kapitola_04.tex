...
\begin{figure}[h!]
  \centering
  \subfloat[\centering The signal]{{\includegraphics[width=7cm]{cosine.pdf} }}%
  \qquad
  \subfloat[\centering Its embedding in $\mathbb{R}^{3}$]{{\includegraphics[width=7cm]{point_cloud1.pdf} }}%
...
\begin{figure}[h!]
  \centering
  \subfloat[\centering The signal]{{\includegraphics[width=7cm]{nonperiodic_signal.pdf} }}%
  \qquad
  \subfloat[\centering Its embedding in $\mathbb{R}^{3}$]{{\includegraphics[width=7cm]{point_cloud2.pdf} }}%
...
\begin{figure}[h!]
  \centering
  \subfloat[\centering Diagram for the periodic wave]{{\includegraphics[width=7cm]{periodic_diagram.pdf} }}%
  \qquad
  \subfloat[\centering Diagram for the quasi-periodic wave]{{\includegraphics[width=7cm]{nonperiodic_diagram.pdf} }}%
...
\begin{figure}[h!]
  \centering
  \subfloat[\centering For the periodic wave]{{\includegraphics[width=7cm]{point_cloud_automatic1.pdf} }}%
  \qquad
  \subfloat[\centering For the quasi-periodic wave]{{\includegraphics[width=7cm]{point_cloud_automatic2.pdf} }}%
...
\begin{figure}[h!]
  \centering
  \subfloat[\centering For the periodic wave]{{\includegraphics[width=7cm]{periodic_automatic_diagram.pdf} }}%
  \qquad
  \subfloat[\centering For the quasi-periodic wave]{{\includegraphics[width=7cm]{nonperiodic_automatic_diagram.pdf} }}%
